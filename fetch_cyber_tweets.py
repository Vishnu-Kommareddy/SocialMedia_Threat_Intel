# ==============================================================
# fetch_cyber_tweets.py  ✅ FINAL CROSS-OS + AIRFLOW-READY VERSION
# Cyber Threat Intelligence Data Collection Pipeline
# ==============================================================
...
# ──────────────────────────────────────────────
# 5️⃣ Query Cybersecurity Tweets
# ──────────────────────────────────────────────
DEFAULT_QUERY = (
    'cybersecurity OR "data breach" OR ransomware OR malware OR phishing OR exploit '
    'OR "zero-day" OR vulnerability OR infosec OR hack OR DDoS OR "threat actor" lang:en -is:retweet'
)
...
try:
    ...
    print("⏭️ Skipping fetch_cyber_tweets task gracefully (API quota limit or bad query).")
    exit(0)
...
for tweet in tweets.data:
    ...
    data.append({
        ...
        "sentiment": None,  # placeholder for later analysis
    })
...
# 7️⃣ Save Locally
# ──────────────────────────────────────────────
csv_path = os.path.join(DATA_DIR, "cyber_tweets.csv")
...
# 9️⃣ End of Script
# ──────────────────────────────────────────────
log("🏁 Cyber Threat tweet fetch completed successfully.")
